...
Before implementing UI, CSS, HTML, accessibility, client-side interaction, animation, image loading, or frontend performance work, consult the installed skill at:

```sh
npx -y modern-web-guidance@latest search "<task description>"
```
