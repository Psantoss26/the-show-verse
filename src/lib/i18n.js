const translations = {
  "es-ES": {
    ...
    search_placeholder: "Buscar películas, series, personas, usuarios o colecciones...",
    search_mobile_placeholder: "Buscar...",
    search_filter_button: "Filtrar búsqueda",
    search_filter_menu: "Filtrar por",
    search_filter_all: "Todo",
    search_filter_movies: "Películas",
    search_filter_series: "Series",
    search_filter_collections: "Colecciones",
    search_filter_users: "Usuarios",
    search_filter_people: "Actores y directores",
    search_filter_no_results: "No hay resultados para este filtro.",
    search_prev_page: "Resultados anteriores",
    search_next_page: "Más resultados",
    search_page_label: "Página",
    search_badge_actor: "Actor/actriz",
    search_badge_director: "Director/a",
    search_badge_user: "Usuario",
    search_user_follower: "seguidor",
    search_user_followers: "seguidores",
  ...
  "en-US": {
    ...
    search_placeholder: "Search movies, shows, people, users or collections...",
    search_mobile_placeholder: "Search...",
    search_filter_button: "Filter search",
    search_filter_menu: "Filter by",
    search_filter_all: "All",
    search_filter_movies: "Movies",
    search_filter_series: "TV shows",
    search_filter_collections: "Collections",
    search_filter_users: "Users",
    search_filter_people: "Actors and directors",
    search_filter_no_results: "No results for this filter.",
    search_prev_page: "Previous results",
    search_next_page: "More results",
    search_page_label: "Page",
    search_badge_actor: "Actor",
    search_badge_director: "Director",
    search_badge_user: "User",
    search_user_follower: "follower",
    search_user_followers: "followers",
