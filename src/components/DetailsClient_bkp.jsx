...
export default function DetailsClient({
    ...
    const resolveProviderUrl = (provider) => {
        if (!provider) {
            return `https://www.themoviedb.org/${endpointType}/${id}/watch`
        }

        const byName = PROVIDER_URLS[provider.provider_name]
        if (byName) return byName

        // Fallback: página de proveedores de TMDb si no tenemos URL específica
        return `https://www.themoviedb.org/${endpointType}/${id}/watch`
    }
