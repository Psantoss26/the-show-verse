        ...
        >
          <div className="flex items-start justify-between gap-4 bg-white/[0.035] p-5 backdrop-blur-xl">
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/5 text-white/70 shadow-sm transition hover:bg-white/10 hover:text-white"
              aria-label="Cerrar"
            >
              <X className="w-5 h-5" />
            </button>
              ...
              <>
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    type="button"
                    onClick={onClose}
                    className={`${ButtonBase} flex-1 bg-white/5 py-3 text-white/75 hover:bg-white/10 hover:text-white`}
                  >
                    Cancelar
                  </button>
      ...
      >
        ...
        <div className="z-30 flex shrink-0 items-center justify-between bg-white/[0.035] px-6 py-5 backdrop-blur-xl sm:px-8 sm:pt-8 sm:pb-6">
          <div className="min-w-0 pr-4">
            ...
            {totals.totalEpisodes > 0 && (
              <div className="flex items-center gap-3 mt-2">
                <div className="h-1.5 w-28 overflow-hidden rounded-full bg-black/35 backdrop-blur-md">
                  <div
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border-0 bg-white/5 text-white/70 shadow-none transition hover:bg-white/10 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/80"
                    ...
                    filteredEpisodes.map((ep) => {
                      ...
                      return (
                        <div
                          ...
                          className={`group flex cursor-pointer gap-3 rounded-2xl border-0 bg-white/[0.035] bg-gradient-to-r from-white/[0.055] via-white/[0.03] to-transparent p-2 shadow-none backdrop-blur-xl transition hover:bg-white/[0.075] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 sm:gap-4 sm:p-3 ${
                            isRewatchView
                              ? "focus-visible:outline-purple-300/60"
                              : "focus-visible:outline-emerald-300/60"
                          }`}
                        >
                          <div className="relative aspect-video w-24 shrink-0 overflow-hidden rounded-xl border-0 bg-black/30 shadow-none sm:w-32">
                            {img ? (
                              <OptimizedImage
                                src={img}
                                alt=""
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar p-4 space-y-4 pb-20 sm:pb-4">
              {seasonsFilteredForTable.map((s) => {
                ...
                return (
                  <div
                    key={sn}
                    className="rounded-2xl bg-white/[0.045] p-4 backdrop-blur-xl"
                  >
                    <div className="flex justify-between items-center mb-3">
                      <h4 className="text-sm font-bold text-white">
                        {seasonLabelText(sn, s.name)}
                      </h4>
                      <span className="rounded-md bg-black/30 px-2 py-1 text-xs font-medium text-white/45">
                        {watchedCount}/{total}
                      </span>
                    </div>
              ...
              >
                <div className="flex items-start justify-between gap-4 bg-white/[0.025] p-5">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/5 text-white/70 shadow-sm transition hover:bg-white/10 hover:text-white disabled:opacity-50"
                    aria-label="Cerrar"
                  >
                    <X className="w-5 h-5" />
                  </button>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                    <button
                      ...
                      disabled={addPlayBusy}
                      onClick={() => setAddPlayOpen(false)}
                      className="rounded-full bg-white/5 py-3 text-sm font-black text-white/75 transition hover:bg-white/10 hover:text-white disabled:opacity-50"
                    >
                      Cancelar
                    </button>
                  ...
                  <div className="max-h-[55vh] overflow-y-auto sv-scroll space-y-2 pr-1">
                    {visibleHistory.length === 0 ? (
                      ...
                      visibleHistory.map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between gap-3 rounded-2xl bg-white/[0.06] px-4 py-3 backdrop-blur-xl"
                        >
                          <div className="min-w-0">
                    ...
                    {visibleHistory.length < filteredHistory.length && (
                      <button
                        ...
                        className="w-full mt-2 py-3 rounded-2xl bg-white/5 hover:bg-white/10 text-white font-black text-sm transition"
                      >
                        Mostrar más (
