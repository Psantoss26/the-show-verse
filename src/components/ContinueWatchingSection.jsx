...
function ContinueWatchingSection({
  ...
  // (isHoveringFirst/LastVisible): al previsualizar la primera/última tarjeta
  // visible, la flecha correspondiente sigue visible SUPERPUESTA sobre la preview
  // (z-[110]) y se puede seguir desplazando con el cursor en esa zona. Sin preview
  // se conserva la supresión.
  const showPrev =
          ...
          {showPrev && !isMobile && (
            ...
            >
              {/* Panel difuminado REDONDEADO (inset-y-2 + rounded-3xl): oscuro en el
                  ...
                  deja un hueco transparente hacia el borde de pantalla, sin zona
                  oscura sólida en ese lateral. */}
              <span
                aria-hidden
