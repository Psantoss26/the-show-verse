  ...
  if (loading) {
    return (
      <div className="max-w-5xl mx-auto px-4 py-10 flex items-center gap-2">
        ...
        <span>Cargando tus favoritas...</span>
      </div>
    )
  }
    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3 text-sm">
          {/* Tipo */}
          <div className="flex gap-1 bg-neutral-900/70 border border-neutral-700 rounded-2xl p-1">
            <button
            ...
            return (
              ...
              >
                <div className="relative aspect-[2/3] overflow-hidden rounded-3xl bg-neutral-900 mb-2">
                  ...
                  {/* TMDb + IMDb: sólo en hover con animación desde la derecha */}
                  <div
                    className="
                      pointer-events-none
