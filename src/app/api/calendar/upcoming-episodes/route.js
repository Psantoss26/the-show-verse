// src/app/api/calendar/upcoming-episodes/route.js
// Próximos episodios de series para la sección "Calendario" del home. Proxy al
// backend `/v1/calendar/episodes` (BBDD propia + TMDB, SIN Trakt):
...
export async function GET(request) {
  ...
  try {
    ...
    if (hasBackendCredentials(request)) {
      const backend = await backendFetchJson(request, "/v1/calendar/episodes");
    ...
    const anon = await fetch(`${baseUrl}/v1/calendar/episodes`, {
