...
export async function GET() {
    try {
        ...
        const [moviesRaw, showsRaw] = await Promise.all([
            fetchTrakt(`/movies/anticipated?extended=full&limit=${limitEach}`),
            fetchTrakt(`/shows/anticipated?extended=full&limit=${limitEach}`),
        ])
        ...
        console.error('trakt discover anticipated error', e)
