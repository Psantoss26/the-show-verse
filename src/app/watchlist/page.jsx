...
import { Loader2, Bookmark, FilmIcon, TvIcon } from 'lucide-react'
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        console.error(err)
        setItems([])
        setError('No se ha podido cargar tu lista de pendientes. Inténtalo de nuevo más tarde.')
      } finally {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <p className="text-neutral-400 max-w-md">
          Inicia sesión para acceder a tu lista personal de películas y series pendientes.
        </p>
        <Link
          href="/login"
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400">{items.length} títulos en tu lista de pendientes</p>
            </div>
          </div>
        ...
        {isInitialLoading ? (
          <div className="flex items-center justify-center py-20 min-h-[50vh] gap-3">
            ...
            <span className="text-neutral-300 text-lg">Cargando tu lista de pendientes...</span>
          </div>
        ) : error ? (
