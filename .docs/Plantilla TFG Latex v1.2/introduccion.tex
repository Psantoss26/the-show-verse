...
\textbf{Objetivo general:} diseñar e implementar una aplicación web completa y funcional para la gestión personalizada y el descubrimiento de nuevas películas y series, que integre múltiples APIs externas y ofrezca una experiencia de usuario centralizada, moderna y eficiente.
...
\item Implementar un sistema de seguimiento episódico completo para series, incluyendo marcado individual por episodio, marcado masivo por temporada, visualización de progreso y grid de ratings para detección de patrones de calidad.
...
\item Desarrollar componentes interactivos avanzados con efectos visuales mediante Canvas 2D (LiquidButton) y sistema de actualización optimista para todas las acciones de usuario.
...
\item Desplegar la aplicación en un entorno de producción (Vercel) con métricas de rendimiento óptimas (LCP <2\,s, CLS <0,1, Performance >90/100).
\end{enumerate}
