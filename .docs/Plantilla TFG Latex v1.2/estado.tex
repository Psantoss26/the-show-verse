...
OAuth 2.0 es el estándar que permite a una aplicación actuar en nombre de un usuario en un servicio externo sin que ese servicio tenga que proporcionarle su contraseña. En \textit{The Show Verse} se utiliza para conectar la cuenta de Trakt.tv del usuario con la aplicación.
...
\textbf{OMDb API} se utiliza como fuente complementaria para enriquecer fichas con metadatos y puntuaciones externas vinculadas al identificador de IMDb. Su integración se realiza mediante peticiones de lectura a través de la API interna del proyecto para unificar formato de respuesta y control de errores.
